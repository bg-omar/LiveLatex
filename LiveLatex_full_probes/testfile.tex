...
% No stix: clashes with textcomp and exhausts classic TeX symbol-font slots with amssymb.
\usepackage{textgreek,gensymb}
\usepackage{longtable}


% Canonical symbols
\newcommand{\vswirl}{v_{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}}}
% Preview / test helper: line below uses this name; keep in sync with your paper's clockwise convention.
\newcommand{\vswirlcw}{-\vswirl}
\newcommand{\SwirlClock}{S_{(t)}^{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}}}
\newcommand{\omegas}{\boldsymbol{\omega}_{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}}}  % swirl vorticity
\newcommand{\vscore}{\mathbf{v}_{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}}}                    % shorthand: |v_swirl| at r=r_c
...
\newcommand{\Om}{\Omega_{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}}}                   % swirl angular frequency profile
...
\begin{document}
    ...
    \begin{abstract}
        ...
        \begin{equation}
            S_{(t)}^{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \int \rhof \vswirl \, dV
        \end{equation}

        Or as anti version \(S_{(t)}^{\mkern-2mu\scriptscriptstyle\boldsymbol{\circlearrowleft}} = \int \rhof \vswirlcw \, dV\).
        ...
        and also like this \(e^{i\pi} + 1 = 0\) with \texttt{\textbackslash( ... \textbackslash)}.
    ...
    Shown as plain text in the HTML (verbatim probe; no markdown fences):
    \begin{verbatim}
    [align F1/F2 shown above as MathJax-friendly display math]
    \end{verbatim}
    ...
    \section{Boxes}
    \medbreak\noindent\fbox{\emph{Sample box}}\smallbreak
...
\section{New Section \texorpdfstring{$\omegas$}{omegas}}
This is a new section
\subsection{New Subsection}
This is a new subsection
\subsubsection{New Subsubsection}
This is a new subsubsection
\paragraph{New Paragraph \texorpdfstring{$\omegas$}{omegas}}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{../src/main/resources/META-INF/pluginIcon.png}
