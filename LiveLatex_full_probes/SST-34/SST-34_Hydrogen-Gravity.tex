...
\end{table}
                ...
                % ---- controls ----
                \def\Amp{0.13}
                \def\Turns{2}        % can be non-integer; extrema logic still works
                \def\Samples{100}
                \def\Wth{2.5pt}
                \def\Core{black}     % set to page color for clean masking
                \def\Mask{5.0pt}
                \def\ClrA{blue!60!black}
                \def\ClrB{teal!70!black}
                ...
                \coordinate (P11) at (-1.25, 2.75);
                \def\KPATH{([closed] P1)..(P2)..(P3)..(P4)..(P5)..(P6)..(P7)..(P8)..(P9)..(P10)..(P11)}
